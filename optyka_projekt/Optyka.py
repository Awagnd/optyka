                ...
                if Typ == 2:
                    ...
                    if event.type == pygame.MOUSEBUTTONUP and event.button == 1:
                        if acc.collidepoint(mousePos):
                            ...
                            for n in range(3):
                                for ni in range(l):
                                    if 1200 > pryzmatyhitbox[-1][n][ni][0] > 0 and 800 > pryzmatyhitbox[-1][n][ni][1] > 0:
                    ...
                    #         elif collide-circle(mousePos, pryzmatypkt[2], 15):
                        ...
                        if x.collidepoint(R[0]):
                            if Collck[0][0] == 4:
                                ...
                                if spr * normalize > 1:
                                    ...
                                    add = 0
                                kont = math.degrees(math.radians(270) + math.radians(Collck[0][1] + osidgh) - math.asin(
                                    spr % normalize)) - add * normalize
                                if kont > 360:
                                    kont -= 360
                                check2 = [1, b]
